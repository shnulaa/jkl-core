...
public class NoBootTest {
    ...
    public void testSort() {
        List<com.jkinvest.jkl.core.file.entity.File> list = new ArrayList<>();
        list.add(com.jkinvest.jkl.core.file.entity.File.builder().id(3L).build());
        list.add(com.jkinvest.jkl.core.file.entity.File.builder().id(1L).build());
        list.add(com.jkinvest.jkl.core.file.entity.File.builder().id(2L).build());
        list.add(com.jkinvest.jkl.core.file.entity.File.builder().id(5L).build());
