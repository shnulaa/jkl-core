...
import com.jkinvest.jkl.core.authority.dao.auth.MenuMapper;
import com.jkinvest.jkl.core.authority.dao.auth.ResourceMapper;
...
import com.jkinvest.jkl.core.authority.entity.common.LoginLog;
...
public class TestResource {
    ...
    public void testDict() {
        ...
        Collection<com.jkinvest.jkl.core.authority.entity.common.Dictionary> dictionaryList = new ArrayList<>();
        dictionaryList.add(com.jkinvest.jkl.core.authority.entity.common.Dictionary.builder().type("AAA").name("BBBB").build());
