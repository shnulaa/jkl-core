...
CREATE TABLE `c_common_area` (
  ...
  `label` varchar(150) NOT NULL DEFAULT '' COMMENT '名称',
...
CREATE TABLE `c_common_login_log` (
  ...
  `browser` varchar(150) DEFAULT NULL COMMENT '浏览器名称',
  `browser_version` varchar(255) DEFAULT NULL COMMENT '浏览器版本',
  `operating_system` varchar(150) DEFAULT NULL COMMENT '操作系统',
...
CREATE TABLE `c_common_parameter` (
  `id` bigint(20) NOT NULL,
  `key_` varchar(150) NOT NULL DEFAULT '' COMMENT '参数键',
